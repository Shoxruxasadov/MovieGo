...
import { success, wrong } from "@/utils/toast";
...
export default function Signup() {
  ...
  const auth = async (user: authProps) => {
        ...
        <div id="signup">
          <form onSubmit={handleSubmit(auth)}>
            {screenWidth > 439 && (
              <>
                <div className="auth">
                  <p className="providers-paragraph">{t("sign.signup.with")}</p>
            ...
            <div className="name">
              <label htmlFor="firstname" className="firstname">
                ...
                <div className="wrapper">
                  ...
                  <input type="text" placeholder={t("sign.signup.name.first")} id="firstname" {...register("firstname", { required: true })} />
                </div>
              </label>
              <label htmlFor="lastname" className="lastname">
                <p>{t("sign.signup.name.last")}</p>
                <div className="wrapper">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="21"
                  ...
                  <input type="text" placeholder={t("sign.signup.name.last")} id="lastname" {...register("lastname")} />
                </div>
              </label>
            </div>
            ...
            <label htmlFor="repass" className="password">
              ...
              <div className="wrapper pass char">
                ...
                <input type={eyepass ? 'text' : 'password'} placeholder={t("sign.signup.repeat")} id="repass" {...register("repass", { required: true })} />
                <div className="eye" onClick={() => setEyepass(!eyepass)}>
                  {eyepass ? <IoEyeOutline /> : <IoEyeOffOutline />}
                </div>
              </div>
              <span>{t("sign.signup.minimal")}</span>
            </label>

            <button>{t("sign.signup.button")}</button>

            <p className="have">{t("sign.signup.have")} <Link href={'/login'}>{t("sign.login.button")}</Link></p>
              ...
              {screenWidth > 439 && (
                <>
                  <div className="part">
                    ...
                    <h3>{t("sign.signup.invite.title")}</h3>
                    <p>{t("sign.signup.invite.description")}</p>
                  </div>
                  <div className="part">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h3>{t("sign.signup.ensure.title")}</h3>
                    <p>{t("sign.signup.ensure.description")}</p>
                  </div>
                  <div className="part">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h3>{t("sign.signup.security.title")}</h3>
                    <p>{t("sign.signup.security.description")}</p>
                  </div>
                </>
              )}
            </div>
