      ...
      <div className="container">
        ...
        >
          ...
          <div className="credits">
            ...
            <p className="genre">{t("movie.action")}</p>
            <span>•</span>
            <p className="genre">{t("movie.adventure")}</p>
            <span>•</span>
            <p className="time">2{t("movie.h")} 28{t("movie.m")}</p>
          </div>
          <p className="description">{t("movie.descHero")}</p>
